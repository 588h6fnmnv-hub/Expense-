  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="rounded-3xl bg-white/80 p-4 shadow dark:bg-white/5">
      ...
      <div className="rounded-3xl bg-white/80 p-4 shadow dark:bg-white/5">
        <div className="grid grid-cols-2 gap-2">
          <select
            ...
            className="min-w-0 rounded-2xl border border-black/10 bg-white/70 px-3 py-3 text-sm font-bold outline-none dark:border-white/10 dark:bg-white/10"
          >
