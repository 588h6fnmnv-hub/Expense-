...
export default function EntrySheet({
  ...
  return (
    ...
    >
      <div
        className="wallet-card max-h-[88dvh] w-full max-w-md overflow-y-auto rounded-[32px] bg-white p-5 text-neutral-950 shadow-2xl dark:bg-neutral-900 dark:text-white pb-[calc(env(safe-area-inset-bottom,0px)+4rem)]"
      ...
      >
        ...
        <div className="mt-5 space-y-3">
          {isBalance ? (
            <>
              <input
                className="w-full rounded-3xl border border-neutral-200 bg-neutral-50 p-4 font-bold text-neutral-950 placeholder:text-neutral-400 outline-none"
