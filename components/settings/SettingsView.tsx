        ...
        <div className="mt-4 grid gap-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <input
              ...
              className="min-w-0 rounded-2xl border border-black/10 bg-white/70 px-4 py-3 text-sm font-bold outline-none disabled:opacity-50 dark:border-white/10 dark:bg-white/10"
            />
          </div>
          <button
            type="button"
            ...
            >
              ...
              <div className="mt-2 grid grid-cols-2 gap-2">
                <select
                  ...
                  className="min-w-0 rounded-2xl border border-black/10 bg-white/70 px-3 py-2 text-sm font-bold outline-none dark:border-white/10 dark:bg-white/10"
                >
                ...
                <input
                  ...
                  className="min-w-0 rounded-2xl border border-black/10 bg-white/70 px-3 py-2 text-sm font-bold outline-none disabled:opacity-50 dark:border-white/10 dark:bg-white/10"
                />
              </div>
            </div>
          ))}
